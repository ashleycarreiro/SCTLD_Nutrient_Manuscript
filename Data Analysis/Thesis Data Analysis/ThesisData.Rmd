...
```{r, load, include = "true"}
ThesisData <- read.xls("ThesisData/AllNutrientData.xlsx", na.string = "NA", head = T)
ActiveProportionData <- read.xls("ThesisData/DiseaseStatusProportions.xlsx")
ExpPhaseModelData <- read.xls("ThesisData/ExpPhaseProportionData.xlsx")
StatusProportionData <- read.xls("ThesisData/ActiveProportions.xlsx")
LesionExpPhaseData <- read.xls("ThesisData/LesionExpPhase.xlsx")
ModelProportionRate <- read.xls("ThesisData/ModelProportionRate.xlsx")
