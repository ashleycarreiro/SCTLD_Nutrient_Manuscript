...
ggsave("Figures/Figure9_SCTLDPrevalence.LineGraph.JPG", plot = SCTLDPrevalence.LineGraph, height = 5, width = 9, units = 'in', dpi = 600)
```
...
ggsave("Figures/Figure10_SCTLDPrevalence.Boxplot.JPG", plot = SCTLDPrevalence.Boxplot, height = 5, width = 9, units = 'in', dpi = 600)
```
